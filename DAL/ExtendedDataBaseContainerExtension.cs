...
namespace DAL
{
    public static class ExtendedDataBaseContainerExtension
    {
        public static void ApplyStateChanges(this ExtendedDataBaseContainer dbContext)
        {
        ...
        public static void ApplyStateToUnchanged(this ExtendedDataBaseContainer dbContext)
        {
            foreach (var dbEntityEntry in dbContext.ChangeTracker.Entries())
            {
                var entityState = dbEntityEntry.Entity as IObjectState;
