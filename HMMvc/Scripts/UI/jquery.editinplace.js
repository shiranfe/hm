...
$.fn.editInPlace.defaults = {
	...
	default_text:		"לחץ להוספה", // string: text to show up if the element that has this functionality is empty
...
$.extend(InlineEditor.prototype, {
	...
	replaceContentWithEditor: function() {
		...
		this.triggerCallback(this.settings.afterCreateEdior, /* DEPRECATED in 2.1.0 */ this.dom);
