...
$(document).ready(function () {
    ...
    var opsGroup = {
        entity: "DynamicGroups",
        cntrl: "/Admin/DynamicGroups",
    };
    ...
    function loadFields() {
        ...
        rest.get(
            $.extend({}, opsGroup, {
                ...
                success: function (data) {
                    ...
                    $(headerActiosClass).html(
                        "<input  type=\"button\" value=\"הוסף שדה\" class=\"OpenAddFieldBtn buttondefault Black\">" +
                       //  '<input  type="button" value="העתק קבוצה" class="CopyGroupBtn buttondefault Black">' +
                        "<input  type=\"button\" value=\"הוסף תת קבוצה\" class=\"OpenAddSubGroupBtn buttondefault Black \">" +
                        "<input  type=\"button\" value=\"הדבק\" class=\"PasteFieldsBtn buttondefault Black dn\">"
                        );
        ...
        var stepName = params.foreignType == "RefubrishStep" ?
            " - " + $("#StepID>option:selected").text() : "";

        $(".PageContHeaderTitle h1").text(
            //$("#DynamicObject>option:selected").text() + 
            //' - ' +
            $("#MachineTypeID>option:selected").text() +
            stepName
            );
