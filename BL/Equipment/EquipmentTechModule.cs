...
namespace BL
{
    public class EquipmentTechModule
    {
        ...
        private readonly IRepository<BankField> _bankFieldDal;
           ...
           [Dependency]DynamicFieldModule dynamicFieldModule)
        {
            ...
            _bankFieldDal = _uow.Repository<BankField>();
        }
        ...
        //    var speedsValues = equipment.Equipment_TechField.Where(y => y.BankField.FieldPoolID == FieldPoolID).ToList();
        ...
        //    var dyncmicField = _bankFieldDal.SingleOrDefault(x => x.FieldPoolID == FieldPoolID && x.DynamicGroup.ForeignType == DynamicObject.MachineType && x.DynamicGroup.ForeignID == equipment.MachineTypeID);
        ...
        //    {
        //        var tachField = speedsValues.ElementAtOrDefault(i);
        //        if (tachField != null)
        //        {
        //            /** update value*/
        ...
        //    int FieldPoolID = 42;
        //    var speedField = equipment.Equipment_TechField.SingleOrDefault(y => y.BankField.FieldPoolID == FieldPoolID);
        ...
        //        y.BankField.FieldNameStr == "Address");

        //    if (addressField == null)
        //    {
        //        /** create speed field value if doesnt exist */
        //        var dyncmicField = _bankFieldDal.SingleOrDefault(x => x.FieldNameStr == "Address" && x.DynamicGroup.ForeignType == DynamicObject.MachineType && x.DynamicGroup.ForeignID == equipment.MachineTypeID);
